<template>
    <div>
        ...
        <el-card>
            ...
            <!--分页  size-change 每页最大变化   current-change 当前最大变化  layout功能组件-->
            <div>
                <el-pagination
        ...
        <el-dialog title="修改用户信息" :visible.sync="editDialogVisible" width="50%" @colse="editDialogClosed">
            <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="70px">
                <!-- 用户名 -->
                <el-form-item label="用户名" prop="username">
                    <el-input v-model="editForm.username"></el-input><!--disabled不可修改-->
                </el-form-item>
                <!-- 密码 -->
                <el-form-item label="密码" prop="password">
    ...
    export default {
        ...
        methods: {
            ...
            async getUserList() {
                ...
                this.userlist = res.data; // 将返回数据赋值,用户裂变数据封装
                this.total = res.numbers; // 总个数
            },
            // 监听pageSize(每页最大数)改变的事件
